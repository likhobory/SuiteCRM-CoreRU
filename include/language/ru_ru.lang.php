...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'Sync' => 'Синхронизация',
        'CalendarAccount' => 'Учётные записи календаря',
        'Users' => 'Пользователи',
        ...
        'OAuth2AuthCodes' => 'OAuth-коды авторизации',
    ),
...
//       it is the key for the default case_relationship_type_dom value
   ...
   // Added by RAPIRA <-
    ...
    'file_field_storage_type_dom' => [
        'private-documents' => 'Личные документы',
        'public-documents' => 'Публичные документы',
        'archived-documents' => 'Архивные документы',
    ],


    'image_field_storage_type_dom' => [
        'private-images' => 'Личные изображения',
    ...
    'dom_manual_migration_tasks_types' => [
        ...
        'immediate' => 'Немедленное выполнение',
    ],
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Результаты поиска',
    ...
    'LBL_OAUTH_CONNECTION_NOT_SET' => 'Настройте внешнее подключение OAuth.',
    'LBL_EMAIL_PASSWORD_NOT_SET' => 'Внимание: пароль не установлен.',
...
'LBL_EMAIL_FOLDERS_SHORT' => SugarThemeRegistry::current()->getImage(
    ...
    'LBL_EMAIL_DRAFT_SAVED' => 'Черновик сохранён.',
...
'LBL_EMAIL_SEARCH_SHORT' => SugarThemeRegistry::current()->getImage(
    ...
    'LBL_EMAIL_SETTINGS_TITLE' => 'Параметры электронной почты',
    ...
    'LBL_HIDE' => 'Скрыть',
    'LBL_HISTORY' => 'История',
    'LBL_NEW' => 'Новая запись', ////
    'LBL_ID' => 'ID',
    'LBL_IMPORT' => 'Импорт',
    'LBL_IMPORT_STARTED' => 'Импорт начат: ',
    'LBL_LAST_VIEWED' => 'Последние просмотры',
    'LBL_LAST_VIEWED_NO_RESULT' => 'Последние просмотры отсутствуют',
    ...
    'LBL_CAMPAIGN_SEND_ERROR_THRESHOLD_EXCEEDED' => 'Достигнут порог ошибок в пакете сообщений (%d): %s',
    'LBL_CAMPAIGN_SEND_FAILURE_THRESHOLD_EXCEEDED' => 'Превышен порог ошибок в пакете сообщений %d',
    ...
    'LBL_COPY' => 'Копировать',
    'LBL_CANCEL' => 'Отказать.',
    'LBL_CONFIRM' => 'Подтверд.',
    'LBL_SNOOZE' => 'Отложить',
    'LBL_SNOOZE_INLINE_CONFIRM' => 'Отложить? ({{preferences.snooze_alert_timer|enum:snooze_alert_timer_simple}})',
    'LBL_DISMISS' => 'Скрыть',
    'LBL_DISMISS_INLINE_CONFIRM' => 'Скрыть?',
    'LBL_DISMISS_ALL_INLINE_CONFIRM' => 'Скрыть всё?',
    'LBL_DISMISS_ALL_DRAFTS_CONFIRM' => 'Закрыть?',
    'NTC_DISMISS_CONFIRMATION' => 'Вы действительно хотите скрыть это уведомление?',
    'NTC_DISMISS_ALL_CONFIRMATION' => 'Вы действительно хотите скрыть все уведомления?',
    'LBL_ALERT_DISMISS_SUCCESS' => 'Уведомление скрыто',
    'LBL_ALERT_DISMISS_ERROR' => 'При скрытии уведомлений произошла ошибка',
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => 'Уведомления скрыты',
    'LBL_DISMISS_ALL' => 'Закрыть всё',
    'LBL_DISMISS_SUCCESS' => 'Уведомления успешно скрыты',
    'LBL_VERIFY' => 'Проверить',
    'LBL_RESEND' => 'Отправить повторное письмо',
    'LBL_RECORD_DOES_NOT_EXIST' => 'Ошибка получения записи. Возможно, запись была удалена, либо у вас отсутствуют права для её просмотра.',
    'LBL_PROFILE' => 'Мои настройки',
    'LBL_PROFILE_EDIT' => 'Мои настройки',
    ...
    'LBL_FILTER' => 'Фильтр',
    'LBL_CLEAR_FILTER' => 'Очистить фильтр',
    'LBL_FILTER_MODULES' => 'Фильтрация',
    'LBL_SEARCH' => 'Поиск',
    'LBL_SEARCH_ALT' => '',
    ...
    'LBL_EMAIL_MARKETING_NOT_SENT' => 'Маркетинговая кампания не может быть запланирована повторно, поскольку не была завершена.',
    'NTC_RESUME_CONFIRMATION' => 'При возобновлении рассылки в очередь будут добавлены получатели, рассылка которым завершилась неудачей.',
    'LBL_EMAIL_MARKETING_NOT_PAUSED' => 'Маркетинговая кампания не приостановлена, поэтому не может быть возобновлена.',
    'LBL_CAMPAIGN_PAUSED_THRESHOLD' => 'Маркетинговая кампания была приостановлена:',
    ...
    //Meta-Data framework
    'ERR_CANNOT_CREATE_METADATA_FILE' => 'Ошибка: Файл [[file]] не обнаружен, создать его невозможно, поскольку отсутствует соответствующий файл HTML.',
...
"5. Из меню модуля запустите процесс импорта и выберите только что сохранённый файл в качестве источника данных для загрузки"
   ',
    ...
    'ERR_NOTIFICATIONS_MARK_AS_READ' => 'Произошла ошибка при попытке отметить уведомление как прочитанное',
    'ERR_FIELD_LOGIC_BACKEND_CALCULATION' => 'Произошла ошибка при попытке получить значение',
    'LBL_FAILED_TO_UPDATE_TEMPLATE_VARIABLES' => 'Не удалось обновить переменные шаблона',
    ...
    'LBL_DISABLE_USER_2FA' => 'Отключить двухэтапную аутентификацию',
    ...
    'LBL_TOO_FEW_SELECTED' => 'Выбрано неверное количество записей. Вы должны выбрать как минимум это количество записей: {min}.',
    'LBL_TOO_MANY_SELECTED' => 'Выбрано неверное количество записей. Вы должны выбрать максимум это количество записей: {max}.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Для этого действия не могут быть выбраны сразу все записи. Выберите отдельные записи.',
    'LBL_MISSING_HANDLER_DATA' => 'Неизвестная ошибка. В ответе отсутствуют данные обработчика массового обновления записей.',
    'LBL_MISSING_HANDLER' => 'Неизвестная ошибка. Не определён обработчик массового обновления записей.',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Неизвестная ошибка. Отсутствует маршрут массового обновления записей.',
    'LBL_ACTION_ERROR' => 'При выполнении действия произошла неизвестная ошибка',
    'LBL_BULK_ACTION_ERROR' => 'При выполнении массовых действий произошла неизвестная ошибка.',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Записи успешно удалены',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Вы действительно хотите обновить выбранные записи?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Все записи успешно обновлены',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Записи частично обновлены. Некоторые записи обновить не удалось. Детали описаны в лог-файле.',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Нет полей для обновления',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Нет записей для обновления',
    ...
    'LBL_RECORD_DELETE_ALL_SUCCESS' => 'Записи успешно удалены',
    'LBL_RECORD_SNOOZE_SUCCESS' => 'Уведомление отложено',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => 'Годовой доход - по Контрагентам',
    'PIPELINE_BY_SALES_STAGE' => 'Диаграмма стадий общих продаж',
    'LEADS_BY_SOURCE' => 'По источникам Предварит. контактов',
    'LEADS_BY_STATUS' => 'По статусам Предварит. контактов',
    'ACCOUNT_TYPES_PER_MONTH' => 'Новые Контрагенты - по месяцам',
    ...
    'LBL_HIDE_SECRET' => 'Скрыть секретный код',
...
$app_string['LBL_PDF_GENERATION_FAILED'] = 'Невозможно создать документ PDF. Подробная информация описана в журнале.';
...
$app_list_strings['moduleList']['ManualMigrationTasks'] = 'Миграция';
$app_list_strings['moduleList']['Processes'] = 'Процессы';
$app_list_strings['moduleList']['AsyncTaskItems'] = 'Асинхронное задание';

$app_strings['LNK_USER_MENU_PROCESSES'] = 'Процессы';
...
$app_list_strings['calendar_connection_status_list'] = [
    'never_tested' => 'Подключение не тестировалось',
    'success' => 'Подключено',
...
$app_list_strings['sync_attempt_message_list'] = [
    '' => '',
    'sync_complete' => 'Все встречи синхронизированы.',
    'up_to_date' => 'Нет новых встреч для синхронизации.',
    'meetings_failed' => 'Некоторые встречи не удалось синхронизировать. Проверьте файл журнала.',
    'sync_partial' => 'Часть встреч синхронизирована. Оставшаяся часть ожидает в очереди из-за настроенных администратором ограничений синхронизации.',
    'sync_failed' => 'Встречи не синхронизированы. Проверьте файл журнала.',
];
...
$app_strings['LBL_INSIGHTS'] = 'Аналитика';
$app_strings['LBL_CHARTS'] = 'Диаграммы';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Диаграмма не обнаружена';
$app_strings['LBL_NO_DATA'] = 'Данные отсутствуют';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'При получении метаданных произошла ошибка';
$app_strings['LBL_TOTAL'] = 'Всего'; ////
$app_strings['LBL_ACTIONS'] = 'Действия';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Выберите необходимые субпанели';
$app_strings['LBL_SELECT_ITEM'] = 'Выберите элемент...'; ////
$app_strings['LBL_ITEMS_SELECTED'] = 'элементов выбрано';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Виджет не обнаружен';
$app_strings['LBL_BAD_CONFIG'] = 'Ошибка конфигурации';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Ошибка конфигурации: контекст настроен неправильно';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Ошибка конфигурации: отсутствует файл конфигурации';
...
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Это Обращение открыто в течение';
...
$app_strings['LBL_VALIDATION_ERROR_ATTACHMENT'] = 'Неверный формат вложения.';
...
$app_strings['LBL_VALIDATION_ERROR_VERSIONING'] = "Неверный формат. Ожидалось: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "Неверное значение. Значение должно быть меньше или равно '{{context.max}}'";
...
$app_strings['LBL_SEARCH_ERROR'] = 'Ошибка поиска.';
$app_strings['LBL_FOUND'] = 'Обнаружено';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Произошла ошибка в процессе получения записей';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'Количество записей';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Дата следующего продления Договора';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Общее количество просроченных Счетов ';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Дата следующего взаимодействия'; ////
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Дата последней проведённой Кампании'; ////
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Общее количество открытых Обращений';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = 'Дата последнего События';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = 'Дата последнего взаимодействия';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Общая сумма Сделок';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Дата истечения срока действия Предложения';////
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Общее количество записей';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Дата продления';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Общее количество просроченных Счетов';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Ближайшие мероприятия'; ////
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Последняя Кампания'; ////
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Открытые Обращения';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Последнее События';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Последнее взаимодействие';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Общая сумма';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Дата истечения';
$app_strings['LBL_DEFAULT_TOTAL'] = 'Всего записей'; ////
$app_strings['AOS_Contracts'] = 'Договоры';
$app_strings['AOS_Quotes'] = 'Предложения';
$app_strings['AOS_Invoices'] = 'Счета';
$app_strings['LBL_PHOTO'] = 'Фото';
...
$app_strings['LBL_QUICK_FILTERS'] = 'Быстрые фильтры';
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Фильтр успешно сохранён';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'Идентификатор фильтра не определён';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Вы хотите продолжить?';
$app_strings['LBL_SHOW_MORE'] = 'Развернуть'; ////
$app_strings['LBL_SHOW_LESS'] = 'Скрыть'; ////
$app_strings['LBL_LOAD_MORE'] = '...ещё'; 
$app_strings['LBL_EMPTY'] = '-- Пустое поле -- ';
$app_strings['LBL_OPERATOR'] = 'Оператор'; ////
$app_strings['LBL_START'] = 'с'; //// с
$app_strings['LBL_END'] = 'по'; //// по
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Некорректная конфигурация'; ////


$app_strings['LBL_ACTION_SUCCESS'] = 'Действие успешно завершено';

$app_strings['LBL_YES'] = 'Да';
$app_strings['LBL_NO'] = 'Нет';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'Восходящая';
$app_list_strings['sort_order']['desc'] = 'Нисходящая';
...
$app_strings['LBL_DELETE_RECORD'] = 'Удалить запись';
...
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Невозможно загрузить запись';
$app_strings['LBL_FILE_NOT_FOUND'] = 'Невозможно загрузить файл';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Невозможно загрузить связь';
$app_strings['LBL_NOT_LINKED'] = 'Невозможно удалить связь. Записи не связаны';
$app_strings['LBL_ACCESS_DENIED'] = 'Доступ запрещён';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Записи успешно добавлены с список Адресатов.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'В процессе добавления записей в список Адресатов произошла ошибка.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Контакты успешно добавлены с список Адресатов.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'В процессе добавления Контактов в список Адресатов произошла ошибка.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'changed to';  //// unused?
$app_strings['LBL_RECORD_CHANGED'] = 'Запись обновлена';
...
$app_strings['LBL_OUTBOUND_ACCOUNT'] = 'Учётная запись исходящей почты';
$app_strings['LBL_INBOUND_ACCOUNT'] = 'Учётная запись входящей почты';
$app_strings['LBL_SYSTEM_ACCOUNT'] = 'Системная учётная запись';
$app_strings['LBL_FROM_SYSTEM'] = 'Персональная учётная запись';
$app_strings['LBL_SIGNATURE'] = 'Подпись';
$app_strings['LBL_NEW_NOTIFICATION'] = "Новых уведомлений: {{context.unread}}";
$app_strings['LBL_ALERT_STATUS_COMPLETED'] = 'Завершено';
$app_strings['LBL_ALERT_STATUS_COMPLETED_WITH_FAILURES'] = 'Завершено с ошибками';
$app_strings['LBL_ALERT_STATUS_FAILED'] = 'Не выполнено';
...
$app_strings['LBL_EMAIL_MODAL_DRAFT_DYNAMIC_TITLE'] = 'Черновик{{fields.name.value|prefix:\' - \'}}';
...
$app_strings['LBL_INSERT_TEMPLATE_VARIABLE'] = 'Вставить переменную';
...
$app_strings['LBL_ALIGN'] = 'Выровнять';
...
$app_strings['LBL_IS_OUTBOUND_CONNECTED'] = 'Настроен ли почтовый ящик для исходящей почты?';
...
$app_strings['LBL_EMAILS_MAX_RETRIES'] = 'Максимальное количество повторных попыток отправки писем маркетинговой кампании';
$app_strings['LBL_EMAILS_MAX_RETRIES_DYNAMIC_LABEL'] = '{{ fields.campaign_emails_max_retries.value }}';
$app_strings['LBL_EMAILS_THRESHOLD'] = 'Максимальное количество ошибок при отправке писем маркетинговой кампании на пакет';
...
$app_strings['LBL_UPLOAD_FROM_FILES'] = 'Загрузить файлы';
$app_strings['LBL_ATTACH_DOCUMENTS'] = 'Прикрепить документы';
...
$app_strings['LBL_SOME_ATTACHMENTS_FAILED'] = 'Некоторые вложения загрузить не удалось. См. журнал для получения дополнительной информации.';
$app_strings['LBL_UPLOAD_IMAGE'] = 'Загрузить изображение';
$app_strings['LBL_DOWNLOAD_IMAGE'] = 'Скачать изображение';
$app_strings['LBL_PREVIEW_IMAGE'] = 'Предварительный просмотр изображения';
$app_strings['LBL_UPLOAD_IMAGE_DESCRIPTION'] = 'Кликните или перетащите изображение для загрузки';
$app_strings['LBL_INVALID_PROCESS_OPTIONS'] = 'Неверные параметры процесса. См. журнал для получения дополнительной информации.';
$app_strings['LBL_TEMPORARY'] = 'Временный';
...
$app_strings['LBL_UNSUPPORTED_IMAGE_FILE_TYPE'] = 'Этот тип изображения не поддерживается.';
$app_strings['LBL_MALWARE_DETECTED'] = 'В загруженном файле обнаружено вредоносное ПО. Загрузка отклонена.';

$app_strings['LBL_DEFAULT_OUTBOUND_NOT_SET'] = 'Не обнаружена учётная запись исходящей почты';
$app_strings['LBL_SMTP_UNABLE_TO_CONNECT'] = 'Не удалось подключиться к SMTP-серверу с текущими настройками исходящей электронной почты.';
...
$app_strings['LBL_DRAFTS'] = 'Черновики';
$app_strings['LBL_DRAFT_ITEM_LAST_MODIFIED'] = '{{fields.date_modified.value}}';
$app_strings['LBL_DRAFT_ITEM_TO_EMPTY'] = 'Нет получателей';
...
$app_strings['LBL_DRAFTS_DELETED_SUCCESSFULLY'] = 'Черновики успешно удалены.';
$app_strings['LBL_DRAFT_DELETED_SUCCESSFULLY'] = 'Черновик успешно удалён.';
$app_strings['LBL_DRAFTS_DELETED_UNSUCCESSFULLY'] = 'Черновики не удалены успешно. См. журналы для получения дополнительной информации.';
$app_strings['LBL_DRAFT_DELETED_UNSUCCESSFULLY'] = 'Черновик не удален успешно. См. журналы для получения дополнительной информации.';
$app_strings['LBL_OPEN_DRAFT'] = 'Открыть черновик';
$app_strings['LBL_DELETE_DRAFT'] = 'Удалить черновик';
$app_strings['LBL_UNABLE_TO_GET_DRAFT_ID'] = 'Не удалось получить ID черновика.';
$app_strings['LBL_UNABLE_TO_DELETE_DRAFT'] = 'Не удалось удалить черновик.';
$app_strings['LBL_EMAIL_NOT_DRAFT'] = 'Электронное письмо больше не является черновиком.';

$app_strings['LBL_CANNOT_DELETE_LATEST_REVISION'] = 'Невозможно удалить последнюю версию документа.';
$app_strings['LBL_NO_DOCUMENT_ID_PROVIDED'] = 'Не удалось найти документ для удаления версии, идентификатор документа не указан.';
$app_strings['LBL_NO_RECORD_ID_PROVIDED'] = 'Не удалось найти версию документа для удаления, идентификатор записи не указан.';
$app_strings['LBL_DELETE_REVISION_CONFIRM'] = 'Вы действительно хотите удалить эту версию?';
$app_strings['LBL_DOCUMENT_NOT_FOUND'] = 'Документ не найден.';
$app_strings['LBL_EMAIL_ATTACHMENT_DOCUMENT_DELETED'] = 'Один или несколько прикрепленных документов были удалены и не могут быть отправлены.';

$app_strings['LBL_DISMISS_INVALID_STATUS'] = 'Эту запись нельзя закрыть, она ещё в обработке.';
$app_strings['LBL_DISMISS_FAILED'] = 'Не удалось закрыть. Попробуйте ещё раз.';
$app_strings['LBL_RERUN_NOT_ELIGIBLE'] = 'Эта запись не может быть обработана повторно. Возможно, задание не завершилось с ошибками, или повторный запуск может быть неподдерживаемым.';
$app_strings['LBL_RETRY_FAILED_NOT_ELIGIBLE'] = 'Это задание не подлежит повторному запуску. Возможно, оно не завершилось с ошибками, или повторный запуск может быть неподдерживаемым.';
$app_strings['LBL_ASYNC_TASK_UNSUPPORTED_MODULE'] = 'Этот модуль не поддерживает асинхронное выполнение заданий.';
$app_strings['LBL_RERUN_SUCCESS'] = 'Задание было повторно поставлена ​​в очередь и будет запущено с начала.';
$app_strings['LBL_RETRY_FAILED_SUCCESS'] = 'Неудачные элементы были повторно поставлены в очередь на обработку.';

$app_strings['LBL_MIGRATE_GOOGLE_CALENDAR_SYNC_SIBLING_RUNNING'] = 'Невозможно выполнить эту миграцию, пока выполняется/ожидает завершения задание "Синхронизация пользователей Google Календаря".';
$app_strings['LBL_MIGRATE_GOOGLE_CALENDAR_SYNC_USERS_SIBLING_RUNNING'] = 'Невозможно выполнить эту миграцию, пока выполняется/ожидает завершения задание "Синхронизация календаря Google".';
...
$app_strings['LBL_NOT_AUTHORIZED'] = 'Пользователь не авторизован';

$app_strings['LBL_AUTOFILL_MISSING_RELATE_MODULE'] = 'Автозаполнение не удалось: не настроен связанный модуль.';
$app_strings['LBL_AUTOFILL_MISSING_RELATE_ID'] = 'Автозаполнение не удалось: не выбрана связанная запись.';
$app_strings['LBL_AUTOFILL_MISSING_UPDATE_FIELDS'] = 'Автозаполнение не удалось: не настроены поля для обновления.';