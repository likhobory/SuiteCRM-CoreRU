...
'LBL_CHECKSYS_UPLOAD' => 'Доступная для записи папка upload',
    ...
    'LBL_REFER_TO_LOGS' => 'В процессе предварительной проверки были выявлены определённые проблемы. Обратитесь к файлу install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'Невозможно найти заголовок SuiteCRM. Это некорректная страница SuiteCRM.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Невозможно найти файлы cookie, не найден действительный токен. Обратитесь к файлу install.log',
    'LBL_CURL_JSON_ERROR' => 'Пустой результат вызова curl на странице Graphql.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Невозможно получить конфигурацию системы на странице Graphql. Обратитесь к файлу install.log.',
