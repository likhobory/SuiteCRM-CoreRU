...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_MBSTRING' => 'Не найдена функция, связанная с расширением MBSTRING. Вероятно, модуль MBSTRING не включён по умолчанию в PHP и должен быть активирован путём добавления опции --enable-mbstring при сборке PHP. Пожалуйста, обратитесь к руководству пользователя PHP за более подробной информацией.',
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Файл конфигурации существует, но он не доступен для записи. Пожалуйста, выполните необходимые шаги для того, чтобы сделать файл доступным для записи.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Файл config.php не существует. Он будет создан в процессе установки.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Файл config_override.php существует, но он не доступен для записи. Пожалуйста, выполните необходимые шаги для того, чтобы сделать файл доступным для записи.',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Папка \'custom\' существует, но она не доступна для записи. Пожалуйста, выполните необходимые шаги для того, чтобы сделать папку доступной для записи.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => 'Перечисленные файлы или папки не доступны для записи или отсутствуют и не могут быть созданы. Пожалуйста, выполните необходимые шаги для того, чтобы сделать папки доступными для записи.',
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'Папка журнала недоступна для записи',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'Папка кеша недоступна для записи',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'Папка расширений недоступна для записи',
    'ERR_CHECKSYS_ROOT_NOT_WRITABLE' => 'Корневая папка недоступна для записи. Установка не может быть продолжена.',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'Папка \'config/secrets\' недоступна для записи',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'Файл .env или папка, в которой он находится, недоступна для записи.',
    'ERR_CHECKSYS_JSON_NOT_AVAILABLE' => "Необходимые для работы JSON-парсера функции не обнаружены. Вероятно, вам необходимо раскомментировать соответствующее расширение в файле php.ini, или перекомпилировать бинарный файл в соответствии с вашей версией PHP. Пожалуйста, обратитесь к руководству пользователя PHP за более подробной информацией.",
    ...
    'ERR_CHECKSYS_PCRE_VER' => 'Не обнаружена необходимая версия библиотеки PCRE: системе требуется библиотека PCRE library 7.0 или выше для работы с  регулярными выражениями в стиле Perl.',
    ...
    'ERR_DB_EXISTS_WITH_CONFIG' => 'База данных уже существует. Чтобы установить систему с выбранной базой данных, перезапустите процесс установки и выберите параметр "Удалить и создать заново существующие таблицы SuiteCRM?". Для обновления системы используйте Мастер Обновлений в панели администратора. Более детальную информацию о процессе обновления вы можете почерпнуть в <a href="https://docs.suitecrm.com/ru/admin/installation-guide/upgrading" target="_new">Руководстве пользователя и администратора</a>.',
    ...
    'ERR_DB_MYSQL_VERSION' => 'Версия MySQL (%s) не поддерживается. Ознакомьтесь с перечнем поддерживаемых версий в <a href="https://docs.suitecrm.com/ru/admin/compatibility-matrix/" target="_blank">таблице совместимости</a>.',
    ...
    'ERR_DB_PRIV_USER' => 'Необходим логин администратора базы данных. Логин необходим для первичного подключения к базе данных.',
    ...
    'ERR_PERFORM_NO_TCPIP_SIMPLE' => 'Отсутствует подключение к Интернету.',
    ...
    'ERR_UPLOAD_MAX_FILESIZE' => 'Конфигурация PHP должна быть изменена, чтобы разрешить загрузку файлов размером не менее 6 МБ.',
    ...
    'LBL_CANCEL' => 'Отмена',
    'LBL_ACCEPT' => 'Принимаю',
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Доступные для записи подпапки кеша в папке public/legacy',
    'LBL_CHECKSYS_CACHE' => 'Доступные для записи подпапки кеша',
    'LBL_CHECKSYS_EXTENSIONS' => 'Доступная для записи папка расширений',
    'LBL_CHECKSYS_SECRETS' => 'Доступная для записи папка config/secrets',
    'LBL_CHECKSYS_LOGS' => 'Доступная для записи папка журнала',
    'LBL_CHECKSYS_ROOT' => 'Доступная для записи корневая папка',
    ...
    'LBL_CHECKSYS_CONFIG' => 'Доступный для записи файл конфигурации (config.php)',
    'LBL_CHECKSYS_CURL' => 'Модуль cURL',
    'LBL_CHECKSYS_CUSTOM' => 'Доступная для записи папка custom',
    'LBL_CHECKSYS_DATA' => 'Доступные для записи подпапки public/legac/data',
    ...
    'LBL_CHECKSYS_JSON' => 'JSON-парсинг',
    ...
    'LBL_CHECKSYS_ENV' => 'Доступный для записи файл .env',
    ...
    'LBL_CHECKSYS_UPLOAD' => 'Доступная для записи папка upload',
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl-расширение установлено',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Json-расширение установлено',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD-расширение установлено',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL-расширение установлено',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Zip-расширение установлено',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'PDO MySQL-расширение установлено',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'cURL-расширение установлено',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'MB Strings-расширение установлено',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi-расширение установлено',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap-расширение установлено',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'XML-расширение установлено',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP-расширение установлено (необязательно)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP-расширение установлено (необязательно)',
    'LBL_PHP_CHECKS' => 'PHP',
    'LBL_SERVER_CHECKS' => 'СЕРВЕР',
    'LBL_PERMISSION_CHECKS' => 'ПРАВА ДОСТУПА',
    'LBL_CHECK_FAILED' => 'Описание ошибки: ',
    'ERR_CHECKSYS_INTL' => 'Расширение Intl не установлено, обратитесь к системному администратору.',
    'ERR_CHECKSYS_JSON' => 'Расширение JSON не включено, обратитесь к системному администратору.',
    'ERR_CHECKSYS_GD' => 'Расширение GD не включено, обратитесь к системному администратору.',
    'ERR_CHECKSYS_OPENSSL' => 'Расширение OpenSSL не включено, обратитесь к системному администратору.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'Расширение PDO MySQL не включено, обратитесь к системному администратору.',
    'ERR_CHECKSYS_MYSQLI' => 'Расширение MySQLi не включено, обратитесь к системному администратору.',
    'ERR_CHECKSYS_SOAP' => 'Расширение Soap не включено, обратитесь к системному администратору.',
    'ERR_SUHOSIN' => 'Suhosin заблокировал загрузку, добавьте  "upload" в параметр suhosin.executor.include.whitelist (см. более детальную информацию в файле suitecrm.log)',
    'LBL_UNWRITABLE_SUB_DIR' => 'Некоторые подпапки недоступны для записи. Пожалуйста, примите необходимые меры, чтобы сделать папки доступными для записи.',
    'LBL_REFER_TO_LOGS' => 'В процессе предварительной проверки были выявлены определённые проблемы. Обратитесь к файлу logs/install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'Невозможно найти заголовок SuiteCRM. Это некорректная страница SuiteCRM.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Невозможно найти файлы cookie, не найден действительный токен. Обратитесь к файлу logs/install.log',
    'LBL_CURL_JSON_ERROR' => 'Пустой результат вызова curl на странице Graphql.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Невозможно получить конфигурацию системы на странице Graphql. Обратитесь к файлу logs/install.log.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Curl-запрос на главной странице',
    'LBL_CURL_REQUEST_API_PAGE' => 'Curl-запрос (API)',
    'LBL_ERROR_DETAILS' => 'Детальное описание ошибки',
    'LBL_ERROR' => 'Ошибка',
    'LBL_WARNING_DETAILS' => 'Детальное описание предупреждения',
    'LBL_WARNING' => 'Предупреждение::',
    'LBL_SYSTEM_CHECKS' => 'ПРОВЕРКА СИСТЕМЫ',
    'LBL_CRON_INSTRUCTIONS_1' => 'Для запуска планировщика SuiteCRM откройте файл crontab пользователя веб-сервера с помощью команды:',
    'LBL_CRON_INSTRUCTIONS_2' => 'и добавьте в него следующую строку:',
    'LBL_CRON_INSTRUCTIONS_3' => 'Выполняйте настройку планировщика только после завершения установки системы.',
    'LBL_CRON_CONFIGURATION' => 'НАСТРОЙКА ПЛАНИРОВЩИКА',
    'LBL_SETUP_CRONTAB' => 'Измените файл Crontab',
    'LBL_ROUTE_ACCESS_CHECK' => 'ДОСТУП К МАРШРУТУ',
    'LBL_PHP_MEM_1' => 'Лимит памяти, используемой PHP, составляет ',
    'LBL_PHP_MEM_2' => '. Для продолжения установки он должен быть не менее ',
    'LBL_PHP_MEM_3' => 'М.',
    'LBL_CLOSE' => 'Закрыть',
    'LBL_THREE' => '3',
    ...
    'LBL_DISABLED_DESCRIPTION_2' => 'После внесения изменений вы можете нажать на кнопку "Пуск" для начала процесса установки. По окончании установки значение переменной \'installer_locked\' должно быть равно \'true\'.',
    'LBL_DISABLED_DESCRIPTION_3' => 'После внесения изменений обновите страницу для продолжения установки системы.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Предварительные требования',
    'LBL_HIDDEN' => '<i>(скрыт)</i>',
    'LBL_STEP1' => 'Шаг 1 из 2 - Подготовка к установке',
    'LBL_STEP2' => 'Шаг 2 из 2 - Настройка конфигурации',
    'LBL_STEP' => 'Шаг',
    'LBL_CHECKS_PASSED' => 'Все проверки успешно пройдены!',
    'LBL_WARNINGS_FOUND' => 'Найдены предупреждения: проверьте их, прежде чем продолжить установку.',
    'LBL_ERRORS_FOUND' => 'Найдены ошибки: рекомендуется устранить их, прежде чем продолжить установку.',
    'LBL_ERRORS_AND_WARNINGS_FOUND' => 'Найдены ошибки и предупреждения: рекомендуется проверить и устранить их, прежде чем продолжить установку.',
	...
	Список поддерживаемых версий вы можете посмотреть в <a href="https://docs.suitecrm.com/ru/admin/compatibility-matrix/" target="_blank">таблице совместимости</a>.<br>',
...
$contact_user_link_guid',
    ...
    'LBL_OLD_PHP_MSG' => 'Рекомендуемая версия PHP: %s <br />Минимально поддерживаемая версия PHP: %s<br />Вы используете PHP версии %s, которая более не поддерживается: <a href="https://php.net/eol.php">https://php.net/eol.php</a>.<br />Рекомендуется обновить установленную версию PHP, детали описаны на странице разработчика: <a href="https://www.php.net/manual/ru/appendices.php">https://www.php.net/manual/ru/appendices.php</a>. ',
    ...
    'LBL_PROCEED_WITH_WARNINGS' => 'ИГНОРИРОВАТЬ ПРЕДУПРЕЖДЕНИЯ И ПРОДОЛЖИТЬ УСТАНОВКУ',
    'LBL_PROCEED_WITH_ERRORS' => 'ИГНОРИРОВАТЬ ОШИБКИ И ПРОДОЛЖИТЬ УСТАНОВКУ',
    'LBL_PROCEED_WITH_ERRORS_AND_WARNINGS' => 'ИГНОРИРОВАТЬ ОШИБКИ/ПРЕДУПРЕЖДЕНИЯ И ПРОДОЛЖИТЬ УСТАНОВКУ',
    'LBL_RECHECK' => 'ПЕРЕПРОВЕРИТЬ',
    'LBL_VIEW_FULL_ERROR' => 'Описание ошибки',
    'LBL_CLOSE_DESCRIPTION' => 'Закрыть описание',
    'LBL_CONFIG' => 'КОНФИГУРАЦИЯ',
    'LBL_VALIDATION_ERRORS' => 'При проверке возникли ошибки, невозможно выполнить действие.',
    'LBL_CRON_UNRECOMMENDED_USER' => 'Вы работаете под пользователем root, что крайне НЕ РЕКОМЕНДУЕТСЯ, желаете продолжить (y,n)? ',
);