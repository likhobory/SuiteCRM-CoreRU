...
$mod_strings = array(
    ...
    'LBL_GOOGLE_SYNC_MIGRATION_PENDING_TITLE' => 'Требуется миграция синхронизации календаря Google.',
    'LBL_GOOGLE_SYNC_MIGRATION_PENDING_DESC' => 'Обнаружены устаревшие данные синхронизации календаря Google. Прежде чем включать синхронизацию календаря, в разделе «Миграция» в меню администратора запустите миграцию синхронизации календаря Google.',
    'LBL_GOOGLE_SYNC_MIGRATION_FAILED_TITLE' => 'Миграция синхронизации календаря Google завершилась с ошибкой',
    'LBL_GOOGLE_SYNC_MIGRATION_FAILED_DESC' => 'В процессе миграции синхронизации календаря Google возникли ошибки. Перейдите в раздел «Миграция» в меню администратора и повторно запустите процесс миграции либо только для необработанных элементов, либо для всего задания целиком.',
...
<a href="https://docs.suitecrm.com/ru/8.x/admin/configuration/ldap-configuration/" target="_blank">Настройка LDAP</a> в руководстве администратора.',
    ...
    'LBL_MANAGE_MANUAL_MIGRATION_TASKS' => 'Миграция',
    'LBL_MANAGE_MANUAL_MIGRATION_TASKS_DESC' => 'Запуск процессов миграции после обновления системы',

    'LBL_MANAGE_PROCESSES' => 'Процессы',
    'LBL_MANAGE_PROCESSES_DESC' => 'Просмотр запущенных процессов',
