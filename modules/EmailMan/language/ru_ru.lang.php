...
$mod_strings = array(
    ...
    'LBL_DRAFTS_POPUP' => 'Включить всплывающее окно черновиков',
    ...
    'LBL_CAMPAIGN_MAX_RETRIES' => 'Максимальное количество повторных попыток отправки писем на одного получателя в случае ошибки:',
    'LBL_CAMPAIGN_THRESHOLD' => 'Максимальное количество ошибок на пакет, после чего рассылка будет приостановлена (0 - рассылка не будет приостановлена):',
    ...
    'LBL_EMAIL_IMPORT_CONFIGURATION' => 'Параметры импорта электронной почты',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD' => 'Максимальное количество импортируемых писем при выполнении задания планировщика (на каждый почтовый ящик)',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD_DESC' => 'Максимальное количество импортируемых писем при однократном выполнении задания планировщика <b>Проверять почтовые ящики для входящей почты</b>. Значение по умолчанию — 25.  Задание будет обрабатывать указанное здесь количество входящих писем, начиная от самых старых. По достижении порогового значения задание будет остановлено, и для текущего  почтового ящика будет зафиксирована дата последнего импортированного дня. При следующем выполнении задания импорт начнётся с зафиксированной даты.',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START' => 'Отправная точка для импорта писем из новых почтовых ящиков',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START_DESC' => 'Период прошедшего времени, с которого начнется импорт электронных писем, поскольку для новых почтовых ящиков не зафиксирована дата последнего импортированного дня. Например, при указании 30 дней будут обрабатываться сообщения, начиная с писем 30-дневной давности.',
    'LBL_EMAIL_IMPORT_FETCH_UNREAD_ONLY' => 'Импортировать только непрочитанные письма',
);