...
$mod_strings = array (
    ...
    'LBL_SECRET_HASHED'=> 'Секретный ключ',
    'LBL_LEAVE_BLANK'=> 'Оставьте это поле пустым, если не требуется изменить значение ключа',
    'LBL_REMEMBER_SECRET'=> 'Значение сохранённого ключа будет недоступно для чтения.',
	'LBL_REDIRECT_URL' => 'URL перенаправления на страницу авторизации',
